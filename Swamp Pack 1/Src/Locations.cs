...
public class Locations
{
    public static void AddAllLocations()
    {
        ...
        LocationManager.AddLocation(assetBundle, 
            "MWL_GuckPit1", 
            YAMLManager.GetCreatureYamlContent(Swamp_Pack_1Plugin.MWL_GuckPit1_CreatureYamlConfig.Value),
            Swamp_Pack_1Plugin.MWL_GuckPit1_CreatureListConfig.Value, 
            1, 
            YAMLManager.GetLootYamlContent(Swamp_Pack_1Plugin.MWL_GuckPit1_LootYamlConfig.Value), 
            Swamp_Pack_1Plugin.MWL_GuckPit1_LootListConfig.Value,
            LocationConfigs.MWL_GuckPit1_Config);

        LocationManager.AddLocation(assetBundle, 
            "MWL_SwampAltar1", 
            YAMLManager.GetCreatureYamlContent(Swamp_Pack_1Plugin.MWL_SwampAltar1_CreatureYamlConfig.Value),
            Swamp_Pack_1Plugin.MWL_SwampAltar1_CreatureListConfig.Value, 
            5, 
            YAMLManager.GetLootYamlContent(Swamp_Pack_1Plugin.MWL_SwampAltar1_LootYamlConfig.Value), 
            Swamp_Pack_1Plugin.MWL_SwampAltar1_LootListConfig.Value,
            LocationConfigs.MWL_SwampAltar1_Config);
        
        LocationManager.AddLocation(assetBundle, 
            "MWL_SwampAltar2", 
            YAMLManager.GetCreatureYamlContent(Swamp_Pack_1Plugin.MWL_SwampAltar2_CreatureYamlConfig.Value),
            Swamp_Pack_1Plugin.MWL_SwampAltar2_CreatureListConfig.Value, 
            6, 
            YAMLManager.GetLootYamlContent(Swamp_Pack_1Plugin.MWL_SwampAltar2_LootYamlConfig.Value), 
            Swamp_Pack_1Plugin.MWL_SwampAltar2_LootListConfig.Value,
            LocationConfigs.MWL_SwampAltar2_Config);
        
        LocationManager.AddLocation(assetBundle, 
            "MWL_SwampAltar3", 
            YAMLManager.GetCreatureYamlContent(Swamp_Pack_1Plugin.MWL_SwampAltar3_CreatureYamlConfig.Value),
            Swamp_Pack_1Plugin.MWL_SwampAltar3_CreatureListConfig.Value, 
            4, 
            YAMLManager.GetLootYamlContent(Swamp_Pack_1Plugin.MWL_SwampAltar3_LootYamlConfig.Value), 
            Swamp_Pack_1Plugin.MWL_SwampAltar3_LootListConfig.Value,
            LocationConfigs.MWL_SwampAltar3_Config);
        
        LocationManager.AddLocation(assetBundle, 
            "MWL_SwampAltar4", 
            YAMLManager.GetCreatureYamlContent(Swamp_Pack_1Plugin.MWL_SwampAltar4_CreatureYamlConfig.Value),
            Swamp_Pack_1Plugin.MWL_SwampAltar4_CreatureListConfig.Value, 
            5, 
            YAMLManager.GetLootYamlContent(Swamp_Pack_1Plugin.MWL_SwampAltar4_LootYamlConfig.Value), 
        ...
        LocationManager.AddLocation(assetBundle, 
            "MWL_SwampCastle2", 
            YAMLManager.GetCreatureYamlContent(Swamp_Pack_1Plugin.MWL_SwampCastle2_CreatureYamlConfig.Value),
            Swamp_Pack_1Plugin.MWL_SwampCastle2_CreatureListConfig.Value, 
            11, 
            YAMLManager.GetLootYamlContent(Swamp_Pack_1Plugin.MWL_SwampCastle2_LootYamlConfig.Value), 
        ...
        LocationManager.AddLocation(assetBundle, 
            "MWL_SwampGrave1", 
            YAMLManager.GetCreatureYamlContent(Swamp_Pack_1Plugin.MWL_SwampGrave1_CreatureYamlConfig.Value),
            Swamp_Pack_1Plugin.MWL_SwampGrave1_CreatureListConfig.Value, 
            0, 
            YAMLManager.GetLootYamlContent(Swamp_Pack_1Plugin.MWL_SwampGrave1_LootYamlConfig.Value), 
            Swamp_Pack_1Plugin.MWL_SwampGrave1_LootListConfig.Value,
            LocationConfigs.MWL_SwampGrave1_Config);
        
        LocationManager.AddLocation(assetBundle, 
            "MWL_SwampHouse1", 
            YAMLManager.GetCreatureYamlContent(Swamp_Pack_1Plugin.MWL_SwampHouse1_CreatureYamlConfig.Value),
            Swamp_Pack_1Plugin.MWL_SwampHouse1_CreatureListConfig.Value, 
            3, 
            YAMLManager.GetLootYamlContent(Swamp_Pack_1Plugin.MWL_SwampHouse1_LootYamlConfig.Value), 
            Swamp_Pack_1Plugin.MWL_SwampHouse1_LootListConfig.Value,
            LocationConfigs.MWL_SwampHouse1_Config);
        
        LocationManager.AddLocation(assetBundle, 
            "MWL_SwampRuin1", 
            YAMLManager.GetCreatureYamlContent(Swamp_Pack_1Plugin.MWL_SwampRuin1_CreatureYamlConfig.Value),
            Swamp_Pack_1Plugin.MWL_SwampRuin1_CreatureListConfig.Value, 
            8, 
            YAMLManager.GetLootYamlContent(Swamp_Pack_1Plugin.MWL_SwampRuin1_LootYamlConfig.Value), 
