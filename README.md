![More World Locations AIO](https://i.imgur.com/TJGHdDK.png)

# More World Locations
This mod massively enhances the world exploration component of Valheim by adding 141 new custom locations across all biomes and multiple new POI experiences.
...
## Features
- Adds 141 new custom locations across all biomes. Each spawns up to 20 times.
...
## Location Previews
<details>
  <summary>Adds 26 locations to the Meadows.</summary>

  ![Meadows Pack 1](https://i.imgur.com/pPFkrDi.png)

</details>
<details>
  <summary>Adds 34 locations to the Blackforest.</summary>

  ![Blackforest Pack 1](https://i.imgur.com/5lKv9F0.png)

</details>
<details>
  <summary>Adds 28 locations to the Swamp.</summary>

  ![Swamp Pack 1](https://i.imgur.com/l62Do90.png)

</details>
<details>
  <summary>Adds 17 locations to the Mountain.</summary>

  ![Mountains Pack 1](https://i.imgur.com/BvdATdc.png)

</details>
<details>
  <summary>Adds 14 locations to the Plains.</summary>

  ![Plains Pack 1](https://i.imgur.com/APTsEfG.png)

</details>
<details>
  <summary>Adds 21 locations to the Mistlands.</summary>
...
### Skill Books
Skill Books are consumable items that raise a specific skill level when used. They are generated for every skill type in the game and come in 3 tiers. Skill Books are sold by traders and provide a way to invest coins into character progression.
