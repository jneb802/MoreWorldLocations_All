...
public class LocationConfigs
{
    ...
    public static Dictionary<string, LocationConfig> BlackforestPack1LocationConfigs =
        new Dictionary<string, LocationConfig>
        {
            ...
            { "MWL_RuinsTower6_Config", new LocationConfig { Quantity = GetQuantity("MWL_RuinsTower6_Configuration"), Biome = Heightmap.Biome.BlackForest, Priotized = true, ExteriorRadius = 8, ClearArea = true, RandomRotation = false, Group = "Ruins_large", MinDistanceFromSimilar = 512, MaxAltitude = 0, MinDistance = LocationRings.Ring3.MinDistance, InForest = false } },
