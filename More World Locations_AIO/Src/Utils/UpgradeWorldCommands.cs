...
public static class UpgradeWorldCommands
{
    public static void AddUpgradeWorldCommands()
    {
        ...
        UpgradeWorld.Upgrade.Register("mwl_allbiomes", "All MWL locations to the world.", 
            ...
            "MWL_MountainDvergrShrine1,MWL_MountainDvergrShrine2,MWL_MountainOverlook1,MWL_MountainCultShrine1,MWL_RuinsChurch2,MWL_MountainShrine1," +
            ...
            // Mistlands Pack 1 + Adventure (19 locations)
            "MWL_MistFort2,MWL_SecretRoom1,MWL_MistWorkshop1,MWL_MistTower1,MWL_MistWall1,MWL_MistTower2,MWL_MistHut1,MWL_DvergrEitrSingularity1,MWL_DvergrHouse1,MWL_DvergrHouseWood1,MWL_DvergrHouseWood2,MWL_MarbleJail1,MWL_MarbleHome1,MWL_MarbleCliffAltar1,MWL_MistPond1,MWL_MarbleCage1,MWL_DvergrKnowledgeExtractor1,MWL_AncientShrine1,MWL_MistShrine1," +
            "MWL_MistHut2," +
        ...
        // Mistlands biome command (19 locations)
