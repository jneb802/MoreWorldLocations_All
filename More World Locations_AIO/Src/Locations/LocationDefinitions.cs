...
public static class LocationDefinitions
{
    ...
    public static readonly MWLLocation[] Swamp =
    {
        ...
        new() { Name = "MWL_SwampShrine1", AssetPath = "Assets/WarpProjects/More World Locations/Swamp/MWL_SwampShrine1.prefab",
            Config = new LocationConfig { Biome = Heightmap.Biome.Swamp, Group = "Swamp_large", Priotized = true, RandomRotation = false, ExteriorRadius = 20, ClearArea = true, MinDistanceFromSimilar = 512, MinTerrainDelta = 0f, MaxTerrainDelta = 8f, MinAltitude = 0f, MinDistance = LocationRings.Ring2.MinDistance, InForest = false, BiomeArea = Heightmap.BiomeArea.Median } },
    ...
    public static readonly MWLLocation[] Ports =
    {
        ...
        new() { Name = "MWL_Port6", AssetPath = "Assets/WarpProjects/More World Locations/Ports/MWL_Port6.prefab",
            Config = new LocationConfig { Biome = Heightmap.Biome.Swamp, Priotized = true, ExteriorRadius = 20, ClearArea = true, RandomRotation = false, MinDistanceFromSimilar = 1024, MaxTerrainDelta = 6f, MinAltitude = -1f, MaxAltitude = 1, SlopeRotation = true, Group = "MWL_Ports", IconPlaced = true } },
    };
