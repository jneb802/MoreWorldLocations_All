...
public class Locations
{
    ...
    public static void AddBlackForestPack1Locations()
    {
        ...
        Common.LocationManager.AddLocation("MWL_Tavern1", BepinexConfigs.bepinexConfigs["MWL_RuinsTavern1_Configuration"], LocationConfigs.BlackforestPack1LocationConfigs["MWL_Tavern1_Config"], More_World_Locations_AIOPlugin.YAMLManager);
