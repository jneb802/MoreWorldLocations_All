...
namespace Swamp_Pack_1
{
    ...
    public class Swamp_Pack_1Plugin : BaseUnityPlugin
    {
        ...
        public void Awake()
        {
            ...
            MWL_SwampComplex1_Configuration = 
                new LocationConfiguration(this.Config, "SwampComplex1", 10, "SwampCreatures2", "SwampLoot1");
            MWL_SwampSanctuary1_Configuration = 
                new LocationConfiguration(this.Config, "SwampSanctuary1", 10, "SwampCreatures2", "SwampLoot1");
            MWL_SwampShrine1_Configuration = 
                new LocationConfiguration(this.Config, "SwampShrine1", 10, "SwampCreatures1", "SwampLoot1");
            MWL_SwampStrongHold1_Configuration 
                = new LocationConfiguration(this.Config, "SwampStrongHold1", 10, "SwampCreatures3", "SwampLoot1");
            MWL_SwampTemple1_Configuration 
                = new LocationConfiguration(this.Config, "SwampTemple1", 10, "SwampCreatures2", "SwampLoot1");
