...
public class Locations
{
    ...
    public static void AddAllLocations()
    {
        ...
        LocationManager.AddLocation(assetBundle, 
            "MWL_RuinsArena2", 
            YAMLManager.GetCreatureYamlContent(BlackForest_Pack_1Plugin.MWL_RuinsArena2_CreatureYaml_Config.Value),
            BlackForest_Pack_1Plugin.MWL_RuinsArena2_CreatureList_Config.Value, 
            10, 
            YAMLManager.GetLootYamlContent(BlackForest_Pack_1Plugin.MWL_RuinsArena2_LootYaml_Config.Value), 
            BlackForest_Pack_1Plugin.MWL_RuinsArena2_LootList_Config.Value,
            LocationConfigs.MWL_RuinsArena2_Config);
        
        LocationManager.AddLocation(assetBundle, 
            "MWL_RuinsCastle1", 
            YAMLManager.GetCreatureYamlContent(BlackForest_Pack_1Plugin.MWL_RuinsCastle1_CreatureYaml_Config.Value),
            BlackForest_Pack_1Plugin.MWL_RuinsCastle1_CreatureList_Config.Value, 
            3, 
            YAMLManager.GetLootYamlContent(BlackForest_Pack_1Plugin.MWL_RuinsCastle1_LootYaml_Config.Value), 
        ...
        LocationManager.AddLocation(assetBundle, 
            "MWL_RuinsTower3", 
            YAMLManager.GetCreatureYamlContent(BlackForest_Pack_1Plugin.MWL_RuinsTower3_CreatureYaml_Config.Value),
            BlackForest_Pack_1Plugin.MWL_RuinsTower3_CreatureList_Config.Value, 
            3, 
            YAMLManager.GetLootYamlContent(BlackForest_Pack_1Plugin.MWL_RuinsTower3_LootYaml_Config.Value), 
            BlackForest_Pack_1Plugin.MWL_RuinsTower3_LootList_Config.Value,
            LocationConfigs.MWL_RuinsTower3_Config);
        
        LocationManager.AddLocation(assetBundle, 
            "MWL_RuinsTower8", 
            YAMLManager.GetCreatureYamlContent(BlackForest_Pack_1Plugin.MWL_RuinsTower8_CreatureYaml_Config.Value),
            BlackForest_Pack_1Plugin.MWL_RuinsTower8_CreatureList_Config.Value, 
            2, 
            YAMLManager.GetLootYamlContent(BlackForest_Pack_1Plugin.MWL_RuinsTower8_LootYaml_Config.Value), 
            BlackForest_Pack_1Plugin.MWL_RuinsTower8_LootList_Config.Value,
            LocationConfigs.MWL_RuinsTower8_Config);
        
        LocationManager.AddLocation(assetBundle, 
            "MWL_Tavern1", 
            YAMLManager.GetCreatureYamlContent(BlackForest_Pack_1Plugin.MWL_Tavern1_CreatureYaml_Config.Value),
            BlackForest_Pack_1Plugin.MWL_Tavern1_CreatureList_Config.Value, 
            3, 
            YAMLManager.GetLootYamlContent(BlackForest_Pack_1Plugin.MWL_Tavern1_LootYaml_Config.Value), 
            BlackForest_Pack_1Plugin.MWL_Tavern1_LootList_Config.Value,
            LocationConfigs.MWL_Tavern1_Config);
        
        LocationManager.AddLocation(assetBundle, 
            "MWL_WoodTower1", 
            YAMLManager.GetCreatureYamlContent(BlackForest_Pack_1Plugin.MWL_WoodTower1_CreatureYaml_Config.Value),
            BlackForest_Pack_1Plugin.MWL_WoodTower1_CreatureList_Config.Value, 
            5, 
            YAMLManager.GetLootYamlContent(BlackForest_Pack_1Plugin.MWL_WoodTower1_LootYaml_Config.Value), 
            BlackForest_Pack_1Plugin.MWL_WoodTower1_LootList_Config.Value,
            LocationConfigs.MWL_WoodTower1_Config);
        
        LocationManager.AddLocation(assetBundle, 
            "MWL_WoodTower2", 
            YAMLManager.GetCreatureYamlContent(BlackForest_Pack_1Plugin.MWL_WoodTower2_CreatureYaml_Config.Value),
            BlackForest_Pack_1Plugin.MWL_WoodTower2_CreatureList_Config.Value, 
            2, 
            YAMLManager.GetLootYamlContent(BlackForest_Pack_1Plugin.MWL_WoodTower2_LootYaml_Config.Value), 
            BlackForest_Pack_1Plugin.MWL_WoodTower2_LootList_Config.Value,
            LocationConfigs.MWL_WoodTower2_Config);
        
        LocationManager.AddLocation(assetBundle, 
            "MWL_WoodTower3", 
            YAMLManager.GetCreatureYamlContent(BlackForest_Pack_1Plugin.MWL_WoodTower3_CreatureYaml_Config.Value),
            BlackForest_Pack_1Plugin.MWL_WoodTower3_CreatureList_Config.Value, 
            5, 
            YAMLManager.GetLootYamlContent(BlackForest_Pack_1Plugin.MWL_WoodTower3_LootYaml_Config.Value), 
