...
namespace MoreWorldLocations_All
{
    ...
    public class MoreWorldLocations_AllPlugin : BaseUnityPlugin
    {
        internal const string ModName = "MoreWorldLocations_All";
        ...
        public static readonly ManualLogSource MoreWorldLocations_AllLogger =
        ...
        private void ReadConfigValues(object sender, FileSystemEventArgs e)
        {
            ...
            try
            {
                MoreWorldLocations_AllLogger.LogDebug("ReadConfigValues called");
                Config.Reload();
            }
            catch
            {
                MoreWorldLocations_AllLogger.LogError($"There was an issue loading your {ConfigFileName}");
                MoreWorldLocations_AllLogger.LogError("Please check your config entries for spelling and format!");
            }
        }
