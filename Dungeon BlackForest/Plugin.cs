...
namespace Dungeon_BlackForest
{
    ...
    public class Dungeon_BlackForestPlugin : BaseUnityPlugin
    {
        internal const string ModName = "Dungeon_BlackForest";
        ...
        public static readonly ManualLogSource Dungeon_BlackForestLogger =
        ...
        private void ReadConfigValues(object sender, FileSystemEventArgs e)
        {
            ...
            try
            {
                Dungeon_BlackForestLogger.LogDebug("ReadConfigValues called");
                Config.Reload();
            }
            catch
            {
                Dungeon_BlackForestLogger.LogError($"There was an issue loading your {ConfigFileName}");
                Dungeon_BlackForestLogger.LogError("Please check your config entries for spelling and format!");
            }
        }
