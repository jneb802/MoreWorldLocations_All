...
namespace BlackForest_Pack_2
{
    ...
    public class BlackForest_Pack_2Plugin : BaseUnityPlugin
    {
        ...
        public static readonly ManualLogSource BlackForest_Pack_2Logger =
        ...
        private void ReadConfigValues(object sender, FileSystemEventArgs e)
        {
            ...
            try
            {
                BlackForest_Pack_2Logger.LogDebug("ReadConfigValues called");
                Config.Reload();
            }
            catch
            {
                BlackForest_Pack_2Logger.LogError($"There was an issue loading your {ConfigFileName}");
                BlackForest_Pack_2Logger.LogError("Please check your config entries for spelling and format!");
            }
        }
