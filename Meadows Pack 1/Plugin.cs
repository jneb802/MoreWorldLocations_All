...
namespace Meadows_Pack_1
{
    ...
    public class Meadows_Pack_1Plugin : BaseUnityPlugin
    {
        ...
        public static readonly ManualLogSource Meadows_Pack_1Logger = BepInEx.Logging.Logger.CreateLogSource(ModName);
        ...
        public void Awake()
        {
            ...
            var example = new global::LocationManager.Location("guildfabs", "GuildAltarSceneFab")
            {
            ...
            global::LocationManager.Location location = new("krumpaclocations", "WaterPit1")
            {
            ...
            {
                Biome = Heightmap.Biome.Meadows,
                GroupSize = new global::CreatureManager.Range(1, 2),
            ...
            wereBearBlack.Drops["Wood"].Amount = new global::CreatureManager.Range(1, 2);
            wereBearBlack.Drops["Wood"].DropChance = 100f;

            Creature wereBearRed = new("werebear", "WereBearRed")
            {
                Biome = Heightmap.Biome.AshLands,
                GroupSize = new global::CreatureManager.Range(1, 1),
            ...
            wereBearRed.Drops["Coal"].Amount = new global::CreatureManager.Range(1, 2);
            wereBearRed.Drops["Coal"].DropChance = 100f;
            wereBearRed.Drops["Flametal"].Amount = new global::CreatureManager.Range(1, 1);
        ...
        private void ReadConfigValues(object sender, FileSystemEventArgs e)
        {
            ...
            try
            {
                Meadows_Pack_1Logger.LogDebug("ReadConfigValues called");
                Config.Reload();
            }
            catch
            {
                Meadows_Pack_1Logger.LogError($"There was an issue loading your {ConfigFileName}");
                Meadows_Pack_1Logger.LogError("Please check your config entries for spelling and format!");
            }
        }
