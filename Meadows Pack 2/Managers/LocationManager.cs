...
public class Location
{
    ...
    {
        softReferences ??= registeredLocations.ToDictionary(l => l,
            l => PrefabManager.AddLoadedSoftReferenceAsset(l.location.gameObject));
    ...
    public static class PrefabManager
    {
        ...
        public static AssetBundle RegisterAssetBundle(string assetBundleFileName, string folderName = "assets")
        {
            ...
            try
            {
                assets = Resources.FindObjectsOfTypeAll<AssetBundle>()
                             .FirstOrDefault(a => a.name == assetBundleFileName) ??
                ...
                if (assets == null)
                {
                    throw new FileNotFoundException(
                        $"AssetBundle {assetBundleFileName} not found in folder {folderName}.");
                }
